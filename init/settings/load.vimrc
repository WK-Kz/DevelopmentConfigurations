" $HOME/.vim/init/settings/ "
" Anything placed below here will probably not change... "
source $HOME/.vim/init/settings/fzf/fzf.vimrc
...
source $HOME/.vim/init/settings/cmake/load_cmake.vimrc
source $HOME/.vim/init/settings/lsp/load_lsp.vimrc
